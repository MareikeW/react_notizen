...
except we've added scroll to top and scroll to bottom buttons. Your job is to expose the 
imperative methods scrollToTop and scrollToBottom on a ref so the parent component 
can call those directly. */

import * as React from 'react'

// React.forwardRef accepts `ref` as the second argument
const MessagesDisplay = React.forwardRef(function MessagesDisplay(
  ...
  // calls useImperativeHandle with ref and a callback function
...
function UseImperativeHandle01() {
...
export default UseImperativeHandle01;
